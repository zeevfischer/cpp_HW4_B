...
TEST_SUITE("Point Class")
{
    ...
    TEST_CASE("moveTowards") 
    {
        ...
        Point temp1 = Point::moveTowards(p1,p2,8);
        CHECK(temp1.get_x() == 5);
        CHECK(temp1.get_y() == 8);

        Point temp2 = Point::moveTowards(p2,p1,8);
        CHECK(temp2.get_x() == 2);
        CHECK(temp2.get_y() == 8);
    }
}
...
TEST_SUITE("Ninja classification")
{
    ...
    {
        Point location{0,0};
        YoungNinja player{"YoungNinja", location};
...
TEST_SUITE("Team")
{
    ...
    TEST_CASE("leader")
    {
        Cowboy* player1 = new Cowboy("alex1" , Point(1,2));
        Cowboy* player2 = new Cowboy("alex2" , Point(3,2));

        Team test1(player1);
        Team test2(player2);

        CHECK(test1.Getleader() == player1);
        CHECK(test2.Getleader() == player2);
    }
    TEST_CASE("baisic2")
    {
        Cowboy* player1 = new Cowboy("one" , Point(1,2));
